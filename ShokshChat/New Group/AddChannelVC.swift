...
class AddChannelVC: UIViewController {
    ...
    @IBAction func createChannelPressed(_ sender: Any) {
        ...
        guard let channelDesk = deskTxt.text, deskTxt.text != "" else {return}
        SocketService.instance.addChannel(channelName: channelName, channelDescription: channelDesk) { (success) in
            if success {
